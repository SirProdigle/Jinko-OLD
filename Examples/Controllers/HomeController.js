const Controller = require("../Controllers/Base/Controller"); //Require base calss controller to extend from
const BigBeepMiddleware = require("../Middleware/Generic/PrintBigBeep"); //Load in a generic middleware
...
class HomeController extends Controller{
    ...
    constructor(){
        super(""); //This dictates the /thing that preceeds this router, e.g if super("test") then all routes follow /test, so a get of "/about" would be /test/about
